...
%         E_temp=[E_temp prev.Ez(meter2index(sX,conf)+i-1,meter2index(sY,conf)+1)]; %Save E_field evolution on 1 column.
        E_temp=[E_temp prev.Ez(meter2index(sX,conf)+1,meter2index(sY,conf)+i-1)];
    end
end
